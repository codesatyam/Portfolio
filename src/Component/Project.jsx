  ...
  return (
    ...
    <Navbar/>
     <div className="project">
      ...
      <ProjectCard image={image} title={"Weather App"} subject={"• Weather API is used,gives information about weather"} f1={"Tech Stack: HTML, CSS, Javascript, Node.js, API"} f2={" "} Live="https://temp-app-satyam.herokuapp.com/" Code="https://github.com/codesatyam/Weatherapp" />
